...
declare namespace React {
  ...
  // tslint:disable-next-line:no-empty-interface
  interface HTMLFactory<T extends HTMLElement> extends DetailedHTMLFactory<
    AllHTMLAttributes<T>,
    T
  > {}
  ...
  > extends DOMFactory<P, T> {
    (props?:
      | ClassAttributes<T> & P
      | null, ...children: ReactNode[]): DetailedReactHTMLElement<P, T>;
  }
  ...
  > {
    (props?:
      ...
      | null, ...children: ReactNode[]): ReactSVGElement;
  }
  ...
  interface DOMAttributes<T> extends RDFaAttributes<T> {
    children?: ReactNode;
  ...
  interface ReactChildren {
    map<T>(
      children: ReactNode,
      fn: (child: ReactChild, index: number) => T
    ): T[];
    forEach(
      children: ReactNode,
      fn: (child: ReactChild, index: number) => any
    ): void;
